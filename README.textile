...
= image_tag Gravatar::Image.get_url('user@gmail.com')

Available options: size, filetype, rating, default, secure.
= image_tag Gravatar::Image.get_url('user@gmail.com', :size => 120, :rating => 'x')
= image_tag Gravatar::Image.get_url('user@gmail.com', :filetype => :png, :default => 'monsterid')
